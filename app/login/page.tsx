...
import { createClient } from "@/lib/supabase/client" // Importante: Client Side
...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // 1. Verifica se estamos num fluxo de convite (type=invite na URL)
    ...
    // 2. Ouve mudanças na autenticação (acontece quando o Supabase processa o hash #access_token)
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/40 p-4">
      <Card className="w-full max-w-md border-none shadow-xl">
        ...
        <CardContent>
          ...
          {/* Feedback Visual de Redirecionamento (Link de Convite) */}
          {isRedirecting ? (
